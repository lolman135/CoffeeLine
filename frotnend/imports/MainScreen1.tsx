import svgPaths from "./svg-tpegvdjy05";
import imgImage from "figma:asset/4cdde660d47777025fadcee00ccd217877a36e59.png";
import imgImage1 from "figma:asset/cacb5bfa3a2c41f2bf01f6b83131c1337e02546b.png";
import imgImage2 from "figma:asset/0303b9efc512b515642ae82c8c95ddf5489a1c51.png";
import imgImage3 from "figma:asset/7da29b9834271414e400699aec7ffe2ec031fb93.png";
import imgImage4 from "figma:asset/325f769fc82699baad870ca5ffaea43e92efb7e5.png";
import imgImage5 from "figma:asset/75d54ff1c0c61d1084bd38621ccc695b84284411.png";
...
function Button() {
  return (
    <div className="absolute bg-[darkorange] h-[32px] left-[5px] rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] top-[5px] w-[69px]" data-name="Button">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[20px] left-[34.5px] not-italic text-[14px] text-center text-white top-[6px] translate-x-[-50%] w-[23px]">Всі</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute h-[32px] left-[73.81px] rounded-[8px] top-[5px] w-[96px]" data-name="Button">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[20px] left-[47.56px] not-italic text-[#666666] text-[14px] text-center top-[6px] translate-x-[-50%] w-[50px]">Гаряче</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute h-[28px] left-0 top-0 w-[260px]" data-name="Container">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold h-[21px] leading-[28px] left-[-1px] not-italic text-[#333333] text-[18px] top-[3px] w-[92px]">Айс Латте</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute h-[40px] left-0 top-[32px] w-[260px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[37px] leading-[20px] left-0 not-italic text-[#666666] text-[14px] top-px w-[199px]">Охолоджений латте з льодом</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="absolute h-[28px] left-0 top-[2px] w-[81px]" data-name="Container">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold h-[24px] leading-[28px] left-[-1.5px] not-italic text-[20px] text-[darkorange] top-[2px] w-[84px]">від 65 ₴</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute bg-white h-[490px] left-0 rounded-[12px] top-[513px] w-[294px]" data-name="Container">
      <div className="h-[490px] overflow-clip relative rounded-[inherit] w-[294px]">
        <div className="absolute left-px rounded-tl-[12px] rounded-tr-[12px] size-[292px] top-px" data-name="Image">
          <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-tl-[12px] rounded-tr-[12px] size-full" src={imgImage1} />
        </div>
        <Container17 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#dddddd] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1),0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
function Container25() {
  return (
    <div className="absolute bg-white h-[490px] left-[318px] rounded-[12px] top-[513px] w-[294px]" data-name="Container">
      <div className="h-[490px] overflow-clip relative rounded-[inherit] w-[294px]">
        <div className="absolute left-px rounded-tl-[12px] rounded-tr-[12px] size-[292px] top-px" data-name="Image">
          <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-tl-[12px] rounded-tr-[12px] size-full" src={imgImage2} />
        </div>
        <Container24 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#dddddd] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1),0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
  ...
  return (
    <div className="absolute bg-white h-[490px] left-[318px] rounded-[12px] top-0 w-[294px]" data-name="Container">
      <div className="h-[490px] overflow-clip relative rounded-[inherit] w-[294px]">
        <div className="absolute left-px rounded-tl-[12px] rounded-tr-[12px] size-[292px] top-px" data-name="Image">
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-tl-[12px] rounded-tr-[12px]">
            <img alt="" className="absolute h-full left-[-31.48%] max-w-none top-0 w-[163.64%]" src={imgImage3} />
          </div>
        </div>
        <Container31 />
      </div>
  ...
  return (
    <div className="absolute bg-white h-[490px] left-[636px] rounded-[12px] top-0 w-[294px]" data-name="Container">
      <div className="h-[490px] overflow-clip relative rounded-[inherit] w-[294px]">
        <div className="absolute left-px rounded-tl-[12px] rounded-tr-[12px] size-[292px] top-px" data-name="Image">
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-tl-[12px] rounded-tr-[12px]">
            <img alt="" className="absolute h-full left-[-36.58%] max-w-none top-0 w-[180%]" src={imgImage4} />
          </div>
        </div>
        <Container38 />
      </div>
  ...
  return (
    <div className="absolute bg-white h-[490px] left-[954px] rounded-[12px] top-0 w-[294px]" data-name="Container">
      <div className="h-[490px] overflow-clip relative rounded-[inherit] w-[294px]">
        <div className="absolute left-px rounded-tl-[12px] rounded-tr-[12px] size-[292px] top-px" data-name="Image">
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-tl-[12px] rounded-tr-[12px]">
            <img alt="" className="absolute h-[150%] left-0 max-w-none top-[-34.93%] w-full" src={imgImage5} />
          </div>
        </div>
        <Container45 />
      </div>
...
export default function MainScreen() {
  return (
    <div className="bg-[#fff5e6] relative size-full" data-name="Main Screen 1">
      <Container63 />
    </div>
  );
}