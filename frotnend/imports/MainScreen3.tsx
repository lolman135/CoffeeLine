import svgPaths from "./svg-jshw57ccyx";
...
function Button1() {
  return (
    <div className="absolute bg-[darkorange] h-[32px] left-[169.81px] rounded-[6px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] top-[5px] w-[108px]" data-name="Button">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[20px] left-[54px] not-italic text-[14px] text-center text-white top-[6px] translate-x-[-50%] w-[62px]">Холодне</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute h-[32px] left-[83.38px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[8px] top-[5px] w-[77px]" data-name="Button">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[20px] left-[39px] not-italic text-[#666666] text-[14px] text-center top-[6px] translate-x-[-50%] w-[50px]">Гаряче</p>
    </div>
  );
}
    ...
    <div className="absolute bg-white h-[490px] left-0 rounded-[12px] top-0 w-[294px]" data-name="Container">
      <div className="h-[490px] overflow-clip relative rounded-[inherit] w-[294px]">
        <div className="absolute left-px rounded-tl-[12px] rounded-tr-[12px] size-[292px] top-px" data-name="Image">
          <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-tl-[12px] rounded-tr-[12px] size-full" src={imgImage} />
        </div>
        <Container10 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#dddddd] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1),0px_1px_3px_0px_rgba(0,0,0,0.1)]" />
...
export default function MainScreen() {
  return (
    <div className="bg-[#fff5e6] relative size-full" data-name="Main Screen 3">
      <Container29 />
    </div>
  );
}