import svgPaths from "./svg-tx1lpaij8c";
...
function Frame() {
  return (
    <div className="absolute left-[3px] size-[11px] top-[3px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <g id="Frame">
          <path d={svgPaths.p3fc33700} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container51() {
  return (
    <div className="absolute left-[48px] size-[36px] top-0" data-name="Container">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[20px] leading-[20px] left-[10px] not-italic text-[#0f0f0f] text-[14px] top-[8px] w-[16px]">2</p>
    </div>
  );
}
...
function Button12() {
  return (
    <div className="absolute bg-white left-[96px] rounded-[2px] size-[36px] top-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-neutral-200 border-solid inset-0 pointer-events-none rounded-[2px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <div className="absolute bg-black h-[2px] left-[10px] rounded-[3px] top-[17px] w-[16px]" />
...
function Container57() {
  return (
    <div className="absolute h-[28px] left-0 top-[20px] w-[115px]" data-name="Container">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold h-[21px] leading-[28px] left-0 not-italic text-[#0f0f0f] text-[18px] top-[3px] w-[58px]">140 ₴</p>
    </div>
  );
}
...
function Container60() {
  return (
    <div className="absolute h-[28px] left-0 top-[20px] w-[95px]" data-name="Container">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold h-[21px] leading-[28px] left-[97.23px] not-italic text-[#0f0f0f] text-[18px] text-right top-[3px] translate-x-[-100%] w-[58px]">280 ₴</p>
    </div>
  );
}
...
export default function ProductDetails2Screen() {
  return (
    <div className="bg-[#fff5e6] relative size-full" data-name="Product Details 2 Screen">
      <Container78 />
    </div>
  );
}